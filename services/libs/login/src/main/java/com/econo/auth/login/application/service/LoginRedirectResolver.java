 ...
 *
 * <p>{@link ClientRedirectUriUseCase#findByClientId(String)}로 등록된 redirect_uri Set을 조회하여 결정적으로 첫 번째
...
public class LoginRedirectResolver implements LoginRedirectUseCase {
	...
	private final ClientRedirectUriUseCase clientRedirectUriUseCase;
	...
	public String resolve(String clientId, String defaultUrl) {
		...
		try {
			ClientInfo clientInfo = clientRedirectUriUseCase.findByClientId(clientId);
