...
public enum GrantType {
	 ...
	 * @return null 입력 시 null 반환. 알 수 없는 비-null 값이면 IllegalArgumentException.
	 * @throws IllegalArgumentException null이 아닌 알 수 없는 값인 경우
	 */
	@Nullable
	public static GrantType fromString(@Nullable String value) {
		...
		return switch (value.toLowerCase()) {
			...
			default -> throw new IllegalArgumentException("지원하지 않는 grantType: " + value);
		};
	}
}
