 ...
 *
 * <p>{@link PassportTokenCustomizer}가 클레임 추출에 사용한다. {@link #getMember()}로 원본 도메인 객체에 접근하여 Passport
 * 커스텀 클레임({@code memberId}, {@code loginId}, {@code name}, {@code generation}, {@code status},
 * {@code roles})을 주입한다.
 */
@Getter
