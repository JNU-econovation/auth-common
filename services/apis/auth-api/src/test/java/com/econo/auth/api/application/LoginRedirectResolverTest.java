...
class LoginRedirectResolverTest {
	...
	@Mock private ClientRedirectUriService clientRedirectUriService;
	...
	class ResolveTest {
		...
		void unregisteredClientId_returnsDefaultUrl() {
			// given
			given(clientRedirectUriService.findByClientId("unknown-client"))
		...
		void singleRedirectUri_returnsThatUri() {
			...
			given(clientRedirectUriService.findByClientId(clientId)).willReturn(clientInfo);
