...
class AdminMemberControllerTest {
	...
	class ListMembersTest {
		...
		void listMembers_withAdmin_returns200() throws Exception {
			given(memberRepository.findPaged(0, 20, null)).willReturn(List.of(mockMember(10L, "USER")));
			given(memberRepository.count(null)).willReturn(1L);
		...
		void listMembers_withSuperAdmin_returns200() throws Exception {
			given(memberRepository.findPaged(0, 20, null)).willReturn(List.of());
			given(memberRepository.count(null)).willReturn(0L);
		...
		void listMembers_withRoleFilter_returns200() throws Exception {
			given(memberRepository.findPaged(0, 20, "ADMIN"))
					.willReturn(List.of(mockMember(10L, "ADMIN")));
			given(memberRepository.count("ADMIN")).willReturn(1L);
	...
	class UpdateRoleTest {
		...
		void updateRole_superAdmin_grantAdmin_returns200() throws Exception {
			given(memberRepository.findById(10L)).willReturn(Optional.of(mockMember(10L, "USER")));
		...
		void updateRole_lastSuperAdmin_returns409() throws Exception {
			given(memberRepository.findById(10L)).willReturn(Optional.of(mockMember(10L, "SUPER_ADMIN")));
			given(memberRepository.countByRole("SUPER_ADMIN")).willReturn(1L);
		...
		void updateRole_multipleSuperAdmins_canDemote() throws Exception {
			given(memberRepository.findById(10L)).willReturn(Optional.of(mockMember(10L, "SUPER_ADMIN")));
			given(memberRepository.countByRole("SUPER_ADMIN")).willReturn(2L);
