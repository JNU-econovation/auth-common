...
class AdminRoleControllerTest {
	...
	class UpdateRoleTest {
		...
		void updateRole_withValidApiKey_returns200() throws Exception {
			given(memberRepository.findById(1L)).willReturn(Optional.of(mockMember(1L)));
			...
			then(memberRepository).should().updateRole(1L, "ADMIN");
		}
		...
		void updateRole_superAdmin_returns200() throws Exception {
			...
			then(memberRepository).should().updateRole(1L, "SUPER_ADMIN");
		}
