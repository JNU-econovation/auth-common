...
class AdminClientControllerTest {
	...
	@MockBean private ClientRedirectUriUseCase redirectUriUseCase;
		...
		void register_withAdminPassport_returns201() throws Exception {
			String requestBody =
					"""
										...
										""";
			given(registerOAuthClientUseCase.register(any(RegisterOAuthClientCommand.class)))
	...
	class GetClientTest {
		...
		void getClient_withAdmin_returns200() throws Exception {
			given(redirectUriUseCase.findByClientId("client-uuid-123"))
					.willReturn(
							new ClientRedirectUriUseCase.ClientInfo(
									"client-uuid-123",
									"테스트 SPA",
	...
	class AddRedirectUriTest {
		...
		void addRedirectUri_withAdmin_returns200() throws Exception {
			given(redirectUriUseCase.addRedirectUri("client-uuid-123", "https://new.example.com/cb"))
					.willReturn(
	...
	class RemoveRedirectUriTest {
		...
		void removeRedirectUri_withAdmin_returns200() throws Exception {
			given(redirectUriUseCase.removeRedirectUri("client-uuid-123", "https://old.example.com/cb"))
	...
	class ReplaceRedirectUrisTest {
		...
		void replaceRedirectUris_withAdmin_returns200() throws Exception {
			given(redirectUriUseCase.replaceRedirectUris(eq("client-uuid-123"), any()))
					.willReturn(
