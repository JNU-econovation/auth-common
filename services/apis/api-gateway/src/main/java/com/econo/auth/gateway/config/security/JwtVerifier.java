 ...
 *
 * <p>Spring Bean 사용 시 {@link com.econo.auth.gateway.config.security.GatewaySecurityConfig}에서 {@code
...
public class JwtVerifier {
	 ...
	 * com.econo.auth.gateway.config.security.GatewaySecurityConfig}에서 호출
	 *
